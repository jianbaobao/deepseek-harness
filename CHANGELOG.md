...
## 0.1.0-rc.17 (2026-08-23)
- 新增：桌面端**工具菜单「检查更新 (OTA 升级)」**手动触发——始终提示（有新版→去下载，无新版→"已是最新"），启动后台检查保留
- 新增：`host.checkUpdate` RPC（数据层）——host 端查 GitHub 最新版本，供 web/桌面统一升级探测；web 前端 IApiClient 可用
